                        ...
                        child: Column(
                          children: [
                            _buildSummaryRow(
                              ...
                              text: '11 cursos prácticos: taxes, ventas, marketing, bookkeeping y más beneficios para tu futuro.',
                            ),
                            const Divider(height: 24, color: AppTheme.line),
                            _buildSummaryRow(
                              icon: Icons.check_circle_outline,
                              text: 'Certificaciones reales que te abren puertas: licencias profesionales, notario y más beneficios.',
                            ),
                            const Divider(height: 24, color: AppTheme.line),
                            _buildSummaryRow(
                              icon: Icons.check_circle_outline,
                              text: 'Aprende a tu ritmo, en español, con profesores que ya lo lograron.',
                            ),
                          ],
                        ),
                      ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Text(
                                'BEBE: "El conocimiento es el único activo que nadie te puede quitar. Empieza hoy."',
