...
import 'package:all_benefits_group/features/onboarding/presentation/vendor_info_page.dart';
                        ...
                        child: Column(
                          children: [
                            _buildSummaryRow(
                              ...
                              text: 'Accede a finanzas, taxes, crédito, inmigración, bienes raíces y más beneficios desde una sola app.',
                            ),
                            const Divider(height: 24, color: AppTheme.line),
                            _buildSummaryRow(
                              icon: Icons.check_circle_outline,
                              text: 'Recibe asesoría personalizada y cotizaciones gratis con expertos de confianza.',
                            ),
                            const Divider(height: 24, color: AppTheme.line),
                            _buildSummaryRow(
                              icon: Icons.check_circle_outline,
                              text: 'Protege tu patrimonio, repara tu crédito y haz crecer tu dinero con estrategias reales.',
                            ),
                          ],
                        ),
                      ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Text(
                                'BEBE: "Todo lo que necesitas para construir tu sueño americano, en un solo lugar."',
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const VendorInfoPage(),
                        ),
                      );
                    },
                    child: Container(
