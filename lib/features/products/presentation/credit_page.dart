        ...
        child: Column(
          children: [
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          Text(
                            'Recupera tu crédito, recupera tu poder',
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  showCalendlyInline(context, title: 'Agendar reunión - Crédito');
                },
                child: Container(
                  width: double.infinity,
                  padding: const EdgeInsets.symmetric(vertical: 14),
                    ...
                    Expanded(
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: 'Toca una opción para detalles y reparar.',
                              style: GoogleFonts.nunito(
                                fontSize: 9.5,
