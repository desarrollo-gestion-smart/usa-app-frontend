...
class _AcademiaPageState extends State<AcademiaPage>
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () async {
                  final ctx = context;
                  try {
                    final result = await AuthService.requestProductInfo(productName: 'Academia');
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  showCalendlyInline(context, title: 'Agendar reunión - Academia');
                },
                child: Container(
                  width: double.infinity,
                  padding: const EdgeInsets.symmetric(vertical: 14),
                    ...
                    Expanded(
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: 'Toca un curso para más detalles y comprar.',
                              style: GoogleFonts.nunito(
                                fontSize: 9.5,
  ...
  Widget _buildCursoCard(CourseData course, int index) {
    ...
    return GestureDetector(
      ...
      child: Transform(
        ...
        transform: Matrix4.identity()
          ..setEntry(3, 2, 0.001)
          ..rotateX(isPressed ? 0.1 : 0)
          ..rotateY(isPressed ? -0.1 : 0),
        child: Container(
            ...
            boxShadow: [
              BoxShadow(
                color: isPressed
                    ...
                    : AppTheme.lineDark,
                offset: isPressed ? const Offset(0, 8) : const Offset(0, 2),
                blurRadius: isPressed ? 16 : 4,
              ),
            ],
          ),
          child: Column(
