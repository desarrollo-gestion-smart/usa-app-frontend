...
class MorgueProtectionDetailPage extends StatelessWidget {
  const MorgueProtectionDetailPage({super.key});
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      Text(
                        'Seguro diseñado para pagar la hipoteca en caso de fallecimiento, '
                        'incapacidad o enfermedad grave. Protege tu casa. Protege a tu familia. '
                        'El Seguro de Protección de Hipoteca te ayuda a mantener el pago de tu '
                        'casa cubierto si tú llegas a faltar, garantizando que tus seres queridos '
                        'no pierdan el hogar.',
                        style: GoogleFonts.nunito(
                          fontSize: 14,
