        ...
        child: Column(
          children: [
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          Text(
                            'Elige el tipo de declaración que necesitas',
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  showCalendlyInline(context, title: 'Agendar reunión - Taxes');
                },
                child: Container(
                  width: double.infinity,
                  padding: const EdgeInsets.symmetric(vertical: 14),
                    ...
                    Expanded(
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: 'Toca uno para detalles y calcular.',
                              style: GoogleFonts.nunito(
                                fontSize: 9.5,
