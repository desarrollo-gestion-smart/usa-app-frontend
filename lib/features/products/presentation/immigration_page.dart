...
class _ImmigrationPageState extends State<ImmigrationPage>
        ...
        child: Column(
          children: [
                        ...
                        builder: (context, child) {
                          return Transform.scale(
                            ...
                            child: Container(
                              ...
                              child: ClipOval(
                                child: Image.asset(
                                  'assets/images/bebe/inmigracion.png',
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  showCalendlyInline(context, title: 'Agendar reunión - Inmigración');
                },
                child: Container(
                  width: double.infinity,
                  padding: const EdgeInsets.symmetric(vertical: 14),
                    ...
                    Expanded(
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: 'Toca una opción para más detalles y conocer.',
                              style: GoogleFonts.nunito(
                                fontSize: 9.5,
  ...
  Widget _buildImmigrationOption({
